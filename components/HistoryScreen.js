...
const HistoryScreen = () => {
  ...
  const fetchHistory = async (userId) => {
    try {
      ...
      const response = await fetch('https://64fc-14-185-225-153.ngrok-free.app/classifications/image', {
        method: 'POST',
        headers: {
  ...
  const deleteHistoryItem = async (itemId) => {
    try {
      const response = await fetch(`https://64fc-14-185-225-153.ngrok-free.app/classifications/delete/${itemId}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        }
