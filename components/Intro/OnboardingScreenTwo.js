  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Image
          source={require('../../assets/OnboardingScreenTwo.jpeg')}
          style={styles.image}
          resizeMode="cover"
        />
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subtitle}>
            Our AI technology helps you identify different types of waste accurately.
          </Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  content: {
    ...
    paddingTop: 60, // Thêm dòng này để giống màn hình đầu tiên
  },  
  image: {
    width: '100%',
    height: 300,
